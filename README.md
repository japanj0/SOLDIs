...
- Администратор может видоизменять список с допустимыми ссылками путем удаления всех элементов списка, либо путем удаления последней введённой ссылки

✔ **Защита паролем**  
- Пароль требуется для:  
  - Защиты от закрытия программы
  - Защиты от последующей эксплуатации браузера без ограничений
- Пароль шифруется алгоритмом SHA256, файл с паролем шифруется алгоритмом Fernet
...
- пользователь может восстановить браузер в случае если он его закрыл
---
